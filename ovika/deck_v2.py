...
DECK = [
    ...
    ("Syncopate", 1, "spell", 1, 0, ["counter", "is"]),
    ("Deny the Divine", 3, "spell", 1, 0, ["counter", "is"]),
    ("Untimely Malfunction", 2, "spell", 0, 1, ["counter", "is"]),
    ("Lightning Bolt", 1, "spell", 0, 1, ["removal", "is"]),
    ("Burst Lightning", 1, "spell", 0, 1, ["removal", "is"]),
    ("Scorching Dragonfire", 2, "spell", 0, 1, ["removal", "is"]),
    ("Eject", 4, "spell", 1, 0, ["counter", "draw1", "is"]),
    ("Aetherize", 4, "spell", 2, 0, ["defense", "is"]),
