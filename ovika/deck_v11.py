...
DECK = [
    ...
    # --- v9 fuel package ---
    ("Fact or Fiction", 4, "spell", 2, 0, ["draw4", "is", "buy"]),
    ("Time Reversal", 6, "spell", 2, 0, ["echo", "is", "buy"]),
    ("Treasure Cruise", 8, "spell", 1, 0, ["cruise", "is", "buy"]),
    ("Mystic Remora", 1, "spell", 1, 0, ["remora", "buy"]),
    ("Rhystic Study", 3, "spell", 1, 0, ["rhystic", "buy"]),
    ("Recurring Insight", 6, "spell", 2, 0, ["recurring", "is", "buy"]),
    # --- v10 ramp ---
    ("Thran Dynamo", 4, "spell", 0, 0, ["ramp", "rock", "+3", "buy"]),
    ("Commander's Sphere", 3, "spell", 0, 0, ["ramp", "rock", "+1", "sphere", "buy"]),
    
    
    # --- v11 multipliers ---
    ("Roaming Throne", 4, "creature", 0, 0, ["throne", "buy"]),
    ("Goblin Assault", 3, "spell", 0, 2, ["assault", "buy"]),
    ("Idol of Oblivion", 2, "spell", 0, 0, ["idol", "buy"]),
]
