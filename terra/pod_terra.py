...
Usage:
  python terra/pod_terra.py --seeds 1-36 --turns 14 --workers 4 [--deck deck_terra.py]
"""
import argparse
import csv
import os
...
POD = [
    ("terra deck", "deck_terra.py", "Terra, Magical Adept // Esper Terra"),
...
def play_pod_seed(seed: int, turns: int, log_fn=None, terra_deck: str = "deck_terra.py") -> dict:
    oracle = Oracle()
    decks, commanders = [], []
...
def main():
    ...
    ap.add_argument("--deck", default="deck_terra.py", help="Terra deck file to test")
    args = ap.parse_args()
